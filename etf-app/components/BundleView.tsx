...
export default function BundleView({ address, bundleId, tokenToBeWrapped1Address, tokenToBeWrapped2Address, setBundleId, config, matrixViewRef, pieViewRef, formViewRef, vaultViewRef
}: {
    vaultViewRef: any,
    matrixViewRef: any,
    pieViewRef: any,

...
contract ETFv1 is Ownable, ERC721Multiwrap {
    /*//////////////////////////////////////////////////////////////
    ...
    function depositFunds(
        ...
        if (canBeClosed) {
            ...
            for (uint256 i = 0; i < getTokenCountOfBundle(_bundleId); i += 1) {
                totalValue +=
                    tokenPrices[getTokenOfBundle(_bundleId, i).assetContract] *
                    getTokenOfBundle(_bundleId, i).totalAmount;
            }
            ...
            for (
                ...
                for (
                    ...
                    amountToSend +=
                        (remainingAmount *
                            (tokenPrices[assetContract] * tokenIdToAmount[j])) /
                        totalValue;
                    console.log(
                        addressToSend,
                        assetContract,
                        tokenPrices[assetContract],
                        tokenIdToAmount[j]
                    );
                }
